...
location = "/Users/guillemdomenech/Documents/GitHub/PyTransport/PyTransport" # this should be the location of the PyTransport folder
...
PyTransSetup.compileName3("Step") # this compiles the module with the new potential and places it in the location folder, and adds this folder to the path ready for use
############################################################################################################################################
